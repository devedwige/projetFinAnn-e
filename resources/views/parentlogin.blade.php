                    ...
                    <div class="card-body">
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="registration" role="tabpanel" aria-labelledby="registration-tab">
                                <h6>Veuillez ressaisir vos identifiants des champs suivant: </h6>
                                <form action="{{ route('parentlogin.action') }}" method="POST" class="user">
                                    @csrf
                                    <div class="form-group">
                                        <label for="">Code:</label>
                                        <input type="number" class="form-control" id="text" name="code" placeholder="Veuillez entrer le code de votre enfant :">
                                    </div>
                                    <div class="form-group">
