      ...
      <div class="row p-0 m-0 proBanner" id="proBanner">
        ...
        <div class="main-panel"><br><br><br>
          <div class="content-wrapper" style="background-color: #ffffff;">
            <h1 class="text-center">Liste des enfants ayant faits la consultation</h1><br><br>
        <table class="table" >
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>{{ $consultation->code ?? 'Null'  }}</td>
                            <td>{{ $consultation->centre ?? 'Null' }}</td>
                            <td>{{ $consultation->phone ?? 'Null'  }}</td>
                            <td>{{ $consultation->description ?? 'Null' }}</td>
                            <td>
                                <a href="#" class="btn btn-danger btn-sm" onclick="confirmDelete({{ $consultation->id }})">
