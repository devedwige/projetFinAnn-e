      ...
      <div class="row p-0 m-0 proBanner" id="proBanner">
        ...
        <div class="main-panel"><br><br><br>
          <div class="content-wrapper" style="background-color: #ffffff;">
            <h1 class="text-center">Liste des enfants vaccinés</h1><br><br>
        <table class="table" >
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>{{ $vaccination->code ?? 'Null'  }}</td>
                            <td>{{ $vaccination->centre ?? 'Null' }}</td>
                            <td>{{ $vaccination->phone ?? 'Null'  }}</td>
                            <td>{{ $vaccination->vaccin ?? 'Null' }}</td>
                            <td>{{ $vaccination->description ?? 'Null' }}</td>
                            <td>{{ $vaccination->autre ?? 'Null' }}</td>
                            <td>
                                <a href="#" class="btn btn-danger btn-sm" onclick="confirmDelete({{ $vaccination->id }})">
