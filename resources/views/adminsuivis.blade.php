      ...
      <div class="row p-0 m-0 proBanner" id="proBanner">
        ...
        <div class="main-panel"><br><br><br>
          <div class="content-wrapper" style="background-color: #ffffff;">
            <h1 class="text-center">Liste des enfants suivis</h1><br><br>
        <table class="table" >
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>{{ $suivi->code ?? 'Null'  }}</td>
                            <td>{{ $suivi->centre ?? 'Null' }}</td>
                            <td>{{ $suivi->niveau ?? 'Null'  }}</td>
                            <td>{{ $suivi->poids ?? 'Null' }}</td>
                            <td>{{ $suivi->appreciation ?? 'Null' }}</td>
                            <td>{{ $suivi->taille ?? 'Null' }}</td>
                            <td>{{ $suivi->appreciation1 ?? 'Null' }}</td>
                            <td>{{ $suivi->autre ?? 'Null' }}</td>
                            <td>{{ $suivi->appreciation2 ?? 'Null' }}</td>
                            <td>
                                <a href="#" class="btn btn-danger btn-sm" onclick="confirmDelete({{ $suivi->id }})">
