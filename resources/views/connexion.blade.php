                    ...
                    <div class="card-body">
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="registration" role="tabpanel" aria-labelledby="registration-tab">
                                ...
                                <form action="{{ route('connexion.action') }}" method="POST" class="user">
                                    @csrf
                                    <div class="form-group">
                                        <label for="password">Code :</label>
                                        <input type="password" class="form-control" id="password" name="password" placeholder="Veuillez entrer le code de six chiffre">
                                    </div>
                                    <div class="form-group">
