...
{{-- <section class="container my-5 d-flex justify-content-center background-image-container"> --}}
    <form action="{{ route('consultation.save') }}" method="POST" class="user">
        @csrf
        @if(session('success'))
        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-control" required placeholder="Veuillez décrire le mal de l'enfant:"></textarea>
                </div>
            </div>
        </div>
        <div class="row">
